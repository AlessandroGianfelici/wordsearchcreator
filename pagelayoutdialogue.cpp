...
void PageLayoutDialog::PageSizeChanged()
{
    ...
    {
        if (((qRound(float(PageLayoutDialog::paperSize(static_cast<QPrinter::PageSize>(a)).width))==qRound(float(widthSpinBox->value()*72.0)))&&(qRound(float(PageLayoutDialog::paperSize(static_cast<QPrinter::PageSize>(a)).height))==qRound(float(heightSpinBox->value()*72.0))))||((qRound(float(PageLayoutDialog::paperSize(static_cast<QPrinter::PageSize>(a)).width))==qRound(float(heightSpinBox->value()*72.0)))&&(qRound(float(PageLayoutDialog::paperSize(static_cast<QPrinter::PageSize>(a)).height))==qRound(float(widthSpinBox->value()*72.0)))))
        {
